...
We work in 6-week or 8-week cycles at Overgrad. There are typically six cycles to a year. Two are 8-week cycles, during Summer Hours, and the rest 6-week cycles. This fixed cadence serves to give us an internal sense of urgency, work as a bound to keep projects from ballooning, and provide a regular interval to decide what we’re working on.
...
Ryan and Kevin form the team evaluating pitches for inclusion in the next cycle. Before the start of every cycle, Ryan's kickoff will list all the pitches that have been selected to be worked on.
...
Thus, the fewer other departments a team has to pass through on their road to rolling out a new feature, the better. We should be working on opening all these natural road blocks that form by default when you have awesome, strong departments, such as Ops, QA, support, and so forth.

For example, a team working on a new college search feature should be able to test and integrate their work without involving other teams, unless something special is needed. Other teams shouldn’t need a special heads up, and thus interruption and mental overhead or even guilt from lack of participation.
...
None of this means we can’t talk together or ask experts with more experience or expertise for their advice. It just means it shouldn’t be a required, necessary step to make Overgrad better.
...
This means we rely on everyone at Overgrad to do a lot of self-management. That means setting your own direction when one isn't given. Determining what needs to be done, and doing it, without waiting for someone to tell you to. A manager of one will spend their time well when left to their own devices. There's always more work to be done, always more initiatives to kick off, always more improvement to be had.